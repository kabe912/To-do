  ...
  try {
    ...
    for (const todo of todos) {
      ...
      const [result] = await conn.query(
        ...
        [todo.title, todo.description, todo.category, todo.priority, 'pending', todo.next_due_date, maxPos[0].pos, todo.recurring, calculateNextDue(todo.next_due_date, todo.recurring)]
      );
